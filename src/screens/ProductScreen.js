...
const ProductScreen = () => {
  ...
  return (
    <div className="container-fluid" id="productScreen">
      <Container className="mt-5">
        <Row className="p-2">
          <Col md={1} />
          <Col md={5}>
            <div className="slider-container">Some Image here</div>
          </Col>
          <Col md={5}>
                ...
                <section className="contain">
                  ...
                  <p className="mb-4">
                    <span className="delivery">
                      Product available, Delivery in 3-4 business days{' '}
                    </span>
                  ...
                  <Row>
                    ...
                    <p>
                      ...
                      illustrator Maya Stepien has designed this dancing couple
                      especially for us, with all the joy and attention to
                      detail.
                    </p>
                    ...
                    <p>
                      Our Pfeffer & Frost cards are printed locally in Erlangen
                      (Bavaria) and wrapped by us in FSC certified silk paper.
                    </p>
                    ...
                    <Collapse in={showMaterial}>
                      <p>
                        ...
                        CO2-neutral, printed in Franconia (Germany) with organic
                        paint, free from mineral oil.
                      </p>
                    </Collapse>
